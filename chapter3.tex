...
\subsection{Illustration of the concept}
...
%\STATE $ {\alpha}_{(g^*)} = {\alpha}_{(g^*)} + \Delta {\alpha}$ 
%\STATE $(d_1,d_2) = \text{raycast}(g^*, \bm{f})$
%\ENDWHILE
%\RETURN $g*$
...
\centering
\includegraphics[width=1\linewidth]
{sensitivity_result.png}%\captionsetup{justification=centering}
